...
import { splitBillShareHandler, splitBillDetectionHandler } from './splitBillHandler';
...
export function setupHandlers() {
  ...
  conversationHandlerRegistry.register('bulkDirectionCorrection', bulkDirectionCorrectionHandler, 50);
  ...
  conversationHandlerRegistry.register('splitBillDetection', splitBillDetectionHandler, 80);
