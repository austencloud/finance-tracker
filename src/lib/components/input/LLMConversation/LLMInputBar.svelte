	...
	<form on:submit|preventDefault>
		...
		<div class="button-container">
			...
			<button
                ...
                disabled={!userInput.trim() || $isProcessing || isSubmitting}
            >
                Send
            </button>
		</div>
...
<style>
    ...
    button[type='button']:last-child { /* Target the last button, assuming it's Send */
	...
	@media (max-width: 600px) {
		...
		button[type='button']:last-child { /* Send button */
